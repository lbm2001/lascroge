...
class GraphSaver():
    ...
    def save(self, save_dir: str) -> None:
        ...
        np.save(str(save_path_adj_matrix), np.array(adjs, dtype=np.float32)) #TODO: Check if this works
        np.save(str(save_path_features), np.array(feats, dtype=np.float32))
